...
namespace Inspinia_MVC5.Controllers
{
    ...
    public class ScaffoldingController : Controller
    {
        ...
        public ActionResult Create([Bind(Include="ID,Name,Position,Office,Extn,Salary")] Worker worker)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include="ID,Name,Position,Office,Extn,Salary")] Worker worker)
        {
            if (ModelState.IsValid)
            {
